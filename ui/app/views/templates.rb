...
Templates.define(:users, [:paged_users, :q?, :agency_ref?, :agency_label?, :role?, :sort?], "views/users.erb.html")
Templates.define(:user_edit, [:user, :errors?], "views/user_form.erb.html")
Templates.define(:locations, [:paged_results, :q?, :agency_ref?, :agency_label?, :sort?], "views/locations.erb.html")
...
Templates.define(:file_issue_requests, [:paged_results, :digital_request_status?, :physical_request_status?, :sort?], "views/file_issue_requests.erb.html")
...
Templates.define(:file_issues, [:paged_results, :sort?, :issue_type?, :status?], "views/file_issues.erb.html")
