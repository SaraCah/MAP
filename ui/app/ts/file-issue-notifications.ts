...
<span class="notification">
    <template v-if="file_issues.length > 0">
        <span class="yellow-text text-darken-3" :title="file_issues.length + ' file issue notifications'" v-on:click="showNotifications()"><i aria-hidden="true" class="fa fa-flag" style="font-size:16px;"></i></span>
