    ...
    <div class="card-content">
        <form action="/users" method="get">
            <div class="row">
                ...
                <div v-if="show_agency_filter" class="col s12 m4">
                    <div class="input-field">
...
`,
    data: function(): {query: string, selectedAgencyRef: string, selectedAgencyLabel: string, selectedRole: string} {
        return {
            query: this.q || '',
    ...
    props: ['q', 'agency_ref', 'agency_label', 'role', 'show_agency_filter'],
    methods: {
