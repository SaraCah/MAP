require_relative 'transfer_file'
...
class Transfer
  ...
  STATUS_TRANSFER_PROCESS_CANCELLED_BY_AGENCY = 'TRANSFER_PROCESS_CANCELLED_BY_AGENCY'
  STATUS_TRANSFER_PROCESS_CANCELLED_BY_QSA = 'TRANSFER_PROCESS_CANCELLED_BY_QSA'
  ...
  STATUS_OPTIONS = [STATUS_TRANSFER_PROCESS_INITIATED,
                    ...
                    STATUS_TRANSFER_PROCESS_CANCELLED_BY_AGENCY,
                    STATUS_TRANSFER_PROCESS_CANCELLED_BY_QSA]
  ...
  def active?
    [
     STATUS_TRANSFER_PROCESS_INITIATED,
     STATUS_TRANSFER_PROCESS_PENDING,
     STATUS_TRANSFER_PROCESS_IN_PROGRESS
    ].include?(self.fetch('status'))
  end
end
